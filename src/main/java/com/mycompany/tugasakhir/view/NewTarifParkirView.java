...
/**
 * JFrame Form untuk menu Kelola Tarif.
 */
public class NewTarifParkirView extends javax.swing.JFrame {

    private final Map<String, NavButton> navButtons = new HashMap<>();
    private String currentCardName = "TARIF";

    private JMenuItem menuLogout;
    private JMenu menuMasterData;
    private JMenu menuLaporan;

    public NewTarifParkirView() {
        initComponents();
        initNavButtonStates();
        buildMenuBar();
        setupAccessControl();
    ...
    private void initComponents() {
        ...
        tarifParkirPanel = new com.mycompany.tugasakhir.view.panel.TarifParkirPanel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Sistem Parkir Desktop - Kelola Tarif");
        ...
        contentArea.add(tarifParkirPanel, "TARIF");
    ...
    private com.mycompany.tugasakhir.view.panel.TarifParkirPanel tarifParkirPanel;
