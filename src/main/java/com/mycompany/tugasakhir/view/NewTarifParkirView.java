...
/**
 * JFrame Form untuk NewTarifParkirView.
 */
public class NewTarifParkirView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Kelola Tarif Progresif Parkir");
        ...
        lblContentTitle.setText("Kelola Tarif Progresif Parkir");
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {
                "ID", "Jenis Kendaraan", "Tarif Awal", "Tarif Progresif", "Status"
            }
        ) {
