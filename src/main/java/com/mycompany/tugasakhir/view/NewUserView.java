...
public class NewUserView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        userPanel = new com.mycompany.tugasakhir.view.panel.UserPanel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Sistem Parkir Desktop - Kelola User");
    ...
    private com.mycompany.tugasakhir.view.panel.UserPanel userPanel;
