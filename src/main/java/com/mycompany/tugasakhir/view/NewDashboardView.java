...
import com.mycompany.tugasakhir.view.panel.*;
...
/**
 * JFrame Form untuk Dashboard Utama (NewDashboardView).
 */
public class NewDashboardView extends javax.swing.JFrame {
    ...
    public NewDashboardView() {
        ...
        // Bangun JMenuBar programmatik bawaan tugas akhir
        buildMenuBar();
        
        // Setup Access Control berdasarkan role user
        setupAccessControl();
        
        // Setup Flying Demo Button kustom
        setupDemoButton();
    ...
    private void initNavButtonStates() {
        ...
        // Highlight menu aktif pertama kali
        setActiveNavVisual("DASHBOARD");
    }

    private void setupDemoButton() {
        btnDemo = new RoundedButton("DEMO", new Color(255, 193, 7), 20);
    ...
    // ==========================================
    // PUBLIC CONTROLLER API (Sama dengan DashboardView)
    // ==========================================

    public DashboardPanel getDashboardPanel() { return dashboardPanel; }
    
    // Delegasikan panel lain ke router demi backward compatibility
    public TransaksiMasukPanel getTransaksiMasukPanel() { 
        return ViewRouter.getTransaksiMasukView() != null ? ViewRouter.getTransaksiMasukView().getTransaksiMasukPanel() : null; 
    }
    public TransaksiKeluarPanel getTransaksiKeluarPanel() { 
        return ViewRouter.getTransaksiKeluarView() != null ? ViewRouter.getTransaksiKeluarView().getTransaksiKeluarPanel() : null; 
    }
    public KendaraanPanel getKendaraanPanel() { 
        return ViewRouter.getKendaraanView() != null ? ViewRouter.getKendaraanView().getKendaraanPanel() : null; 
    }
    public TarifParkirPanel getTarifParkirPanel() { 
        return ViewRouter.getTarifParkirView() != null ? ViewRouter.getTarifParkirView().getTarifParkirPanel() : null; 
    }
    public PetugasPanel getPetugasPanel() { 
        return ViewRouter.getPetugasView() != null ? ViewRouter.getPetugasView().getPetugasPanel() : null; 
    }
    public UserPanel getUserPanel() { 
        return ViewRouter.getUserView() != null ? ViewRouter.getUserView().getUserPanel() : null; 
    }
    public LaporanPanel getLaporanPanel() { 
        return ViewRouter.getLaporanView() != null ? ViewRouter.getLaporanView().getLaporanPanel() : null; 
    }

    public RoundedButton getBtnDemo() { return btnDemo; }
    ...
    private void initComponents() {
        ...
        dashboardPanel = new com.mycompany.tugasakhir.view.panel.DashboardPanel();
    ...
    private com.mycompany.tugasakhir.view.panel.DashboardPanel dashboardPanel;
